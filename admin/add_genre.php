...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($genre_name)) {
        ...
        $insert_query = "INSERT INTO genre (genre_name) VALUE (?)";
        ...
        if ($stmt = $conn->prepare($insert_query)) {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Error adding genre: " . $stmt->error;
            }
            $stmt->close();
        } else {
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="manage_genres.php" class="active">Manage Genres</a>
    ...
    <div class="main-content">
        <div class="header">
            <a href="manage_genre.php" class="back-link">&larr; Back to Manage Genre</a>
            <h1>Add New Genre</h1>
        </div>
