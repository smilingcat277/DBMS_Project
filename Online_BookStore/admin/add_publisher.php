...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($publisher_name)) {
        ...
        $insert_query = "INSERT INTO Publishers (publisher_name) VALUE (?)";
        ...
        if ($stmt = $conn->prepare($insert_query)) {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Error adding Publisher: " . $stmt->error;
            }
            $stmt->close();
        } else {
...
<head>
    ...
    <title>Add Publisher - Admin</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <a href="manage_publishers.php" class="back-link">&larr; Back to Manage Publishers</a>
